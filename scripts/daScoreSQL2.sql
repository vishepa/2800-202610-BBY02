...
BEGIN
    RETURN CASE p_category
        ...
        WHEN 'Specialty East Asian Food Stores'                       THEN 'retail'
        WHEN 'Specialty European Food Stores'                         THEN 'retail'
        WHEN 'Specialty Filipino Food Stores'                         THEN 'retail'
        WHEN 'Specialty Halal Food Stores'                            THEN 'retail'
        WHEN 'Specialty Japanese Food Stores'                         THEN 'retail'
        WHEN 'Specialty Latin American Food Stores'                   THEN 'retail'
        WHEN 'Specialty Mediterranean and Middle Eastern Food Stores' THEN 'retail'
        WHEN 'Specialty South Asian Food Stores'                      THEN 'retail'
