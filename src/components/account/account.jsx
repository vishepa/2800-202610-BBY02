import { useAuth } from '../shared/authentication/Authentication.jsx'
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col">
      <div className="flex flex-col md:flex-row flex-1 p-5 gap-5">
        ...
        <div className="bg-white shadow-md p-10 rounded-lg w-full md:w-1/3 flex flex-col">
          ...
          <div className="flex flex-col gap-4 bg-gray-100 p-5 rounded-lg shadow-lg">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-2xl">{user?.user_metadata?.full_name ?? 'User'}</h2>
            </div>
            <div>
        ...
        {/*saved sims*/}
        <div className="bg-white shadow-md p-10 rounded-lg w-full md:w-2/3">
        </div>
